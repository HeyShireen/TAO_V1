...
async function runMigration011() {
  ...
  try {
    ...
    console.log('\n📋 Prochaines étapes:');
    console.log('   1. Vérifier avec: node src/app/tools/check-production-db.js');
    console.log('   2. Mettre à jour tous les users: node src/app/tools/verify-all-users.js');
