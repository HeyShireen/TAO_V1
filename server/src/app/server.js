...
import questionConfigRoutes from './routes/questions/config.js'
import optionsRoutes from './routes/options/index.js'
...
const publicDir = path.resolve(__dirname, './public') // server/src/app/public
